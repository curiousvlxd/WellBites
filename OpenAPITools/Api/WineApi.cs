...
namespace com.spoonacular
{
    ...
    public class WineApi : IWineApi
    {
        ...
        /// <param name="wine">The type of wine that should be paired, e.g. \&quot;merlot\&quot;, \&quot;riesling\&quot;, or \&quot;malbec\&quot;.</param>
        /// <returns>GetDishPairingForWine200Response</returns>
        public GetDishPairingForWine200Response GetDishPairingForWine (string wine)
        {
            ...
            return (GetDishPairingForWine200Response) ApiClient.Deserialize(response.Content, typeof(GetDishPairingForWine200Response), response.Headers);
        }
        ...
        /// <param name="wine">The name of the wine that should be paired, e.g. \&quot;merlot\&quot;, \&quot;riesling\&quot;, or \&quot;malbec\&quot;.</param>
        /// <returns>GetWineDescription200Response</returns>
        public GetWineDescription200Response GetWineDescription (string wine)
        {
            ...
            return (GetWineDescription200Response) ApiClient.Deserialize(response.Content, typeof(GetWineDescription200Response), response.Headers);
        }
        ...
        /// <param name="maxPrice">The maximum price for the specific wine recommendation in USD.</param>
        /// <returns>GetWinePairing200Response</returns>
        public GetWinePairing200Response GetWinePairing (string food, decimal? maxPrice)
        {
 ...
 if (maxPrice != null) queryParams.Add("maxPrice", ApiClient.ParameterToString(maxPrice)); // query parameter
            ...
            return (GetWinePairing200Response) ApiClient.Deserialize(response.Content, typeof(GetWinePairing200Response), response.Headers);
        }
        ...
        /// <param name="number">The number of wine recommendations expected (between 1 and 100).</param>
        /// <returns>GetWineRecommendation200Response</returns>
        public GetWineRecommendation200Response GetWineRecommendation (string wine, decimal? maxPrice, decimal? minRating, decimal? number)
        {
 ...
 if (number != null) queryParams.Add("number", ApiClient.ParameterToString(number)); // query parameter
            ...
            return (GetWineRecommendation200Response) ApiClient.Deserialize(response.Content, typeof(GetWineRecommendation200Response), response.Headers);
        }
