...
namespace com.spoonacular
{
    ...
    public class RecipesApi : IRecipesApi
    {
        ...
        /// <param name="q">The recipe search query.</param>
        /// <returns>AnalyzeARecipeSearchQuery200Response</returns>
        public AnalyzeARecipeSearchQuery200Response AnalyzeARecipeSearchQuery (string q)
        {
            ...
            return (AnalyzeARecipeSearchQuery200Response) ApiClient.Deserialize(response.Content, typeof(AnalyzeARecipeSearchQuery200Response), response.Headers);
        }
        ...
        /// <param name="contentType">The content type.</param>
        /// <returns>AnalyzeRecipeInstructions200Response</returns>
        public AnalyzeRecipeInstructions200Response AnalyzeRecipeInstructions (string contentType)
        {
            ...
            return (AnalyzeRecipeInstructions200Response) ApiClient.Deserialize(response.Content, typeof(AnalyzeRecipeInstructions200Response), response.Headers);
        }
        ...
        /// <param name="number">The maximum number of items to return (between 1 and 100). Defaults to 10.</param>
        /// <returns>List&lt;AutocompleteRecipeSearch200ResponseInner&gt;</returns>
        public List<AutocompleteRecipeSearch200ResponseInner> AutocompleteRecipeSearch (string query, int? number)
        {
 ...
 if (number != null) queryParams.Add("number", ApiClient.ParameterToString(number)); // query parameter
            ...
            return (List<AutocompleteRecipeSearch200ResponseInner>) ApiClient.Deserialize(response.Content, typeof(List<AutocompleteRecipeSearch200ResponseInner>), response.Headers);
        }
        ...
        /// <param name="contentType">The content type.</param>
        /// <returns>ClassifyCuisine200Response</returns>
        public ClassifyCuisine200Response ClassifyCuisine (string contentType)
        {
            ...
            return (ClassifyCuisine200Response) ApiClient.Deserialize(response.Content, typeof(ClassifyCuisine200Response), response.Headers);
        }
        ...
        /// <param name="language">The language of the input. Either &#39;en&#39; or &#39;de&#39;.</param>
        /// <returns>ComputeGlycemicLoad200Response</returns>
        public ComputeGlycemicLoad200Response ComputeGlycemicLoad (ComputeGlycemicLoadRequest computeGlycemicLoadRequest, string language)
        {
            
            // verify the required parameter 'computeGlycemicLoadRequest' is set
            if (computeGlycemicLoadRequest == null) throw new ApiException(400, "Missing required parameter 'computeGlycemicLoadRequest' when calling ComputeGlycemicLoad");
            ...
            String postBody = null;
             ...
             if (language != null) queryParams.Add("language", ApiClient.ParameterToString(language)); // query parameter
                                    postBody = ApiClient.Serialize(computeGlycemicLoadRequest); // http body (model) parameter
            ...
            return (ComputeGlycemicLoad200Response) ApiClient.Deserialize(response.Content, typeof(ComputeGlycemicLoad200Response), response.Headers);
        }
        ...
        /// <param name="targetUnit">The unit to which you want to convert, e.g. the grams in \&quot;2.5 cups of flour to grams\&quot;. You can also use \&quot;piece\&quot;, e.g. \&quot;3.4 oz tomatoes to piece\&quot;</param>
        /// <returns>ConvertAmounts200Response</returns>
        public ConvertAmounts200Response ConvertAmounts (string ingredientName, decimal? sourceAmount, string sourceUnit, string targetUnit)
        {
 ...
 if (targetUnit != null) queryParams.Add("targetUnit", ApiClient.ParameterToString(targetUnit)); // query parameter
            ...
            return (ConvertAmounts200Response) ApiClient.Deserialize(response.Content, typeof(ConvertAmounts200Response), response.Headers);
        }
        ...
        /// <param name="contentType">The content type.</param>
        /// <returns>CreateRecipeCard200Response</returns>
        public CreateRecipeCard200Response CreateRecipeCard (string contentType)
        {
            ...
            return (CreateRecipeCard200Response) ApiClient.Deserialize(response.Content, typeof(CreateRecipeCard200Response), response.Headers);
        }
        ...
        /// <param name="includeTaste">Whether taste data should be added to correctly parsed ingredients.</param>
        /// <returns>GetRecipeInformation200Response</returns>
        public GetRecipeInformation200Response ExtractRecipeFromWebsite (string url, bool? forceExtraction, bool? analyze, bool? includeNutrition, bool? includeTaste)
        {
 ...
 if (includeTaste != null) queryParams.Add("includeTaste", ApiClient.ParameterToString(includeTaste)); // query parameter
            ...
            return (GetRecipeInformation200Response) ApiClient.Deserialize(response.Content, typeof(GetRecipeInformation200Response), response.Headers);
        }
        ...
        /// <param name="stepBreakdown">Whether to break down the recipe steps even more.</param>
        /// <returns>GetAnalyzedRecipeInstructions200Response</returns>
        public GetAnalyzedRecipeInstructions200Response GetAnalyzedRecipeInstructions (int? id, bool? stepBreakdown)
        {
            ...
            return (GetAnalyzedRecipeInstructions200Response) ApiClient.Deserialize(response.Content, typeof(GetAnalyzedRecipeInstructions200Response), response.Headers);
        }
        ...
        /// <param name="number">The maximum number of items to return (between 1 and 100). Defaults to 10.</param>
        /// <returns>GetRandomRecipes200Response</returns>
        public GetRandomRecipes200Response GetRandomRecipes (bool? limitLicense, string tags, int? number)
        {
 ...
 if (number != null) queryParams.Add("number", ApiClient.ParameterToString(number)); // query parameter
            ...
            return (GetRandomRecipes200Response) ApiClient.Deserialize(response.Content, typeof(GetRandomRecipes200Response), response.Headers);
        }
        ...
        /// <param name="id">The item&#39;s id.</param>
        /// <returns>GetRecipeEquipmentByID200Response</returns>
        public GetRecipeEquipmentByID200Response GetRecipeEquipmentByID (int? id)
        {
            ...
            return (GetRecipeEquipmentByID200Response) ApiClient.Deserialize(response.Content, typeof(GetRecipeEquipmentByID200Response), response.Headers);
        }
        ...
        /// <param name="includeNutrition">Include nutrition data in the recipe information. Nutrition data is per serving. If you want the nutrition data for the entire recipe, just multiply by the number of servings.</param>
        /// <returns>GetRecipeInformation200Response</returns>
        public GetRecipeInformation200Response GetRecipeInformation (int? id, bool? includeNutrition)
        {
        ...
        /// <param name="includeNutrition">Include nutrition data in the recipe information. Nutrition data is per serving. If you want the nutrition data for the entire recipe, just multiply by the number of servings.</param>
        /// <returns>List&lt;GetRecipeInformationBulk200ResponseInner&gt;</returns>
        public List<GetRecipeInformationBulk200ResponseInner> GetRecipeInformationBulk (string ids, bool? includeNutrition)
        {
 ...
 if (includeNutrition != null) queryParams.Add("includeNutrition", ApiClient.ParameterToString(includeNutrition)); // query parameter
            ...
            return (List<GetRecipeInformationBulk200ResponseInner>) ApiClient.Deserialize(response.Content, typeof(List<GetRecipeInformationBulk200ResponseInner>), response.Headers);
        }
        ...
        /// <param name="id">The item&#39;s id.</param>
        /// <returns>GetRecipeIngredientsByID200Response</returns>
        public GetRecipeIngredientsByID200Response GetRecipeIngredientsByID (int? id)
        {
            ...
            return (GetRecipeIngredientsByID200Response) ApiClient.Deserialize(response.Content, typeof(GetRecipeIngredientsByID200Response), response.Headers);
        }
        ...
        /// <param name="id">The item&#39;s id.</param>
        /// <returns>GetRecipeNutritionWidgetByID200Response</returns>
        public GetRecipeNutritionWidgetByID200Response GetRecipeNutritionWidgetByID (int? id)
        {
            ...
            return (GetRecipeNutritionWidgetByID200Response) ApiClient.Deserialize(response.Content, typeof(GetRecipeNutritionWidgetByID200Response), response.Headers);
        }
        ...
        /// <param name="id">The item&#39;s id.</param>
        /// <returns>GetRecipePriceBreakdownByID200Response</returns>
        public GetRecipePriceBreakdownByID200Response GetRecipePriceBreakdownByID (int? id)
        {
            ...
            return (GetRecipePriceBreakdownByID200Response) ApiClient.Deserialize(response.Content, typeof(GetRecipePriceBreakdownByID200Response), response.Headers);
        }
        ...
        /// <param name="normalize">Normalize to the strongest taste.</param>
        /// <returns>GetRecipeTasteByID200Response</returns>
        public GetRecipeTasteByID200Response GetRecipeTasteByID (int? id, bool? normalize)
        {
            ...
            return (GetRecipeTasteByID200Response) ApiClient.Deserialize(response.Content, typeof(GetRecipeTasteByID200Response), response.Headers);
        }
        ...
        /// <param name="limitLicense">Whether the recipes should have an open license that allows display with proper attribution.</param>
        /// <returns>List&lt;GetSimilarRecipes200ResponseInner&gt;</returns>
        public List<GetSimilarRecipes200ResponseInner> GetSimilarRecipes (int? id, int? number, bool? limitLicense)
        {
 ...
 if (limitLicense != null) queryParams.Add("limitLicense", ApiClient.ParameterToString(limitLicense)); // query parameter
            ...
            return (List<GetSimilarRecipes200ResponseInner>) ApiClient.Deserialize(response.Content, typeof(List<GetSimilarRecipes200ResponseInner>), response.Headers);
        }
        ...
        /// <param name="title">The title of the dish.</param>
        /// <returns>GuessNutritionByDishName200Response</returns>
        public GuessNutritionByDishName200Response GuessNutritionByDishName (string title)
        {
            ...
            return (GuessNutritionByDishName200Response) ApiClient.Deserialize(response.Content, typeof(GuessNutritionByDishName200Response), response.Headers);
        }
        ...
        /// <param name="language">The language of the input. Either &#39;en&#39; or &#39;de&#39;.</param>
        /// <returns>List&lt;ParseIngredients200ResponseInner&gt;</returns>
        public List<ParseIngredients200ResponseInner> ParseIngredients (string contentType, string language)
        {
            ...
            return (List<ParseIngredients200ResponseInner>) ApiClient.Deserialize(response.Content, typeof(List<ParseIngredients200ResponseInner>), response.Headers);
        }
        ...
        /// <param name="q">The nutrition related question.</param>
        /// <returns>QuickAnswer200Response</returns>
        public QuickAnswer200Response QuickAnswer (string q)
        {
            ...
            return (QuickAnswer200Response) ApiClient.Deserialize(response.Content, typeof(QuickAnswer200Response), response.Headers);
        }
 ...
 if (limitLicense != null) queryParams.Add("limitLicense", ApiClient.ParameterToString(limitLicense)); // query parameter
            ...
            return (SearchRecipes200Response) ApiClient.Deserialize(response.Content, typeof(SearchRecipes200Response), response.Headers);
        }
        ...
        /// <param name="ignorePantry">Whether to ignore typical pantry items, such as water, salt, flour, etc.</param>
        /// <returns>List&lt;SearchRecipesByIngredients200ResponseInner&gt;</returns>
        public List<SearchRecipesByIngredients200ResponseInner> SearchRecipesByIngredients (string ingredients, int? number, bool? limitLicense, decimal? ranking, bool? ignorePantry)
        {
 ...
 if (ignorePantry != null) queryParams.Add("ignorePantry", ApiClient.ParameterToString(ignorePantry)); // query parameter
            ...
            return (List<SearchRecipesByIngredients200ResponseInner>) ApiClient.Deserialize(response.Content, typeof(List<SearchRecipesByIngredients200ResponseInner>), response.Headers);
        }
 ...
 if (limitLicense != null) queryParams.Add("limitLicense", ApiClient.ParameterToString(limitLicense)); // query parameter
            ...
            return (List<SearchRecipesByNutrients200ResponseInner>) ApiClient.Deserialize(response.Content, typeof(List<SearchRecipesByNutrients200ResponseInner>), response.Headers);
        }
        ...
        /// <param name="id">The item&#39;s id.</param>
        /// <returns>SummarizeRecipe200Response</returns>
        public SummarizeRecipe200Response SummarizeRecipe (int? id)
        {
            ...
            return (SummarizeRecipe200Response) ApiClient.Deserialize(response.Content, typeof(SummarizeRecipe200Response), response.Headers);
        }
