...
namespace com.spoonacular
{
    ...
    public class ProductsApi : IProductsApi
    {
        ...
        /// <param name="number">The number of results to return (between 1 and 25).</param>
        /// <returns>AutocompleteProductSearch200Response</returns>
        public AutocompleteProductSearch200Response AutocompleteProductSearch (string query, int? number)
        {
 ...
 if (number != null) queryParams.Add("number", ApiClient.ParameterToString(number)); // query parameter
            ...
            return (AutocompleteProductSearch200Response) ApiClient.Deserialize(response.Content, typeof(AutocompleteProductSearch200Response), response.Headers);
        }
        ...
        /// <param name="locale">The display name of the returned category, supported is en_US (for American English) and en_GB (for British English).</param>
        /// <returns>ClassifyGroceryProduct200Response</returns>
        public ClassifyGroceryProduct200Response ClassifyGroceryProduct (ClassifyGroceryProductRequest classifyGroceryProductRequest, string locale)
        {
            
            // verify the required parameter 'classifyGroceryProductRequest' is set
            if (classifyGroceryProductRequest == null) throw new ApiException(400, "Missing required parameter 'classifyGroceryProductRequest' when calling ClassifyGroceryProduct");
            ...
            String postBody = null;
             ...
             if (locale != null) queryParams.Add("locale", ApiClient.ParameterToString(locale)); // query parameter
                                    postBody = ApiClient.Serialize(classifyGroceryProductRequest); // http body (model) parameter
            ...
            return (ClassifyGroceryProduct200Response) ApiClient.Deserialize(response.Content, typeof(ClassifyGroceryProduct200Response), response.Headers);
        }
        ...
        /// <param name="locale">The display name of the returned category, supported is en_US (for American English) and en_GB (for British English).</param>
        /// <returns>List&lt;ClassifyGroceryProductBulk200ResponseInner&gt;</returns>
        public List<ClassifyGroceryProductBulk200ResponseInner> ClassifyGroceryProductBulk (List<ClassifyGroceryProductBulkRequestInner> classifyGroceryProductBulkRequestInner, string locale)
        {
            
            // verify the required parameter 'classifyGroceryProductBulkRequestInner' is set
            if (classifyGroceryProductBulkRequestInner == null) throw new ApiException(400, "Missing required parameter 'classifyGroceryProductBulkRequestInner' when calling ClassifyGroceryProductBulk");
            ...
            String postBody = null;
             ...
             if (locale != null) queryParams.Add("locale", ApiClient.ParameterToString(locale)); // query parameter
                                    postBody = ApiClient.Serialize(classifyGroceryProductBulkRequestInner); // http body (model) parameter
            ...
            return (List<ClassifyGroceryProductBulk200ResponseInner>) ApiClient.Deserialize(response.Content, typeof(List<ClassifyGroceryProductBulk200ResponseInner>), response.Headers);
        }
        ...
        /// <param name="upc">The UPC of the product for which you want to find comparable products.</param>
        /// <returns>GetComparableProducts200Response</returns>
        public GetComparableProducts200Response GetComparableProducts (decimal? upc)
        {
            ...
            return (GetComparableProducts200Response) ApiClient.Deserialize(response.Content, typeof(GetComparableProducts200Response), response.Headers);
        }
        ...
        /// <param name="id">The item&#39;s id.</param>
        /// <returns>GetProductInformation200Response</returns>
        public GetProductInformation200Response GetProductInformation (int? id)
        {
            ...
            return (GetProductInformation200Response) ApiClient.Deserialize(response.Content, typeof(GetProductInformation200Response), response.Headers);
        }
 ...
 if (showIngredients != null) queryParams.Add("showIngredients", ApiClient.ParameterToString(showIngredients)); // query parameter
        ...
        /// <param name="number">The maximum number of items to return (between 1 and 100). Defaults to 10.</param>
        /// <returns>SearchGroceryProducts200Response</returns>
        public SearchGroceryProducts200Response SearchGroceryProducts (string query, decimal? minCalories, decimal? maxCalories, decimal? minCarbs, decimal? maxCarbs, decimal? minProtein, decimal? maxProtein, decimal? minFat, decimal? maxFat, bool? addProductInformation, int? offset, int? number)
        {
 ...
 if (number != null) queryParams.Add("number", ApiClient.ParameterToString(number)); // query parameter
            ...
            return (SearchGroceryProducts200Response) ApiClient.Deserialize(response.Content, typeof(SearchGroceryProducts200Response), response.Headers);
        }
        ...
        /// <param name="upc">The product&#39;s UPC.</param>
        /// <returns>SearchGroceryProductsByUPC200Response</returns>
        public SearchGroceryProductsByUPC200Response SearchGroceryProductsByUPC (decimal? upc)
        {
            ...
            return (SearchGroceryProductsByUPC200Response) ApiClient.Deserialize(response.Content, typeof(SearchGroceryProductsByUPC200Response), response.Headers);
        }
