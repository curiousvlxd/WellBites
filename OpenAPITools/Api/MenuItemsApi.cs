...
namespace com.spoonacular
{
    ...
    public class MenuItemsApi : IMenuItemsApi
    {
        ...
        /// <param name="number">The number of results to return (between 1 and 25).</param>
        /// <returns>AutocompleteMenuItemSearch200Response</returns>
        public AutocompleteMenuItemSearch200Response AutocompleteMenuItemSearch (string query, decimal? number)
        {
 ...
 if (number != null) queryParams.Add("number", ApiClient.ParameterToString(number)); // query parameter
            ...
            return (AutocompleteMenuItemSearch200Response) ApiClient.Deserialize(response.Content, typeof(AutocompleteMenuItemSearch200Response), response.Headers);
        }
        ...
        /// <param name="id">The item&#39;s id.</param>
        /// <returns>GetMenuItemInformation200Response</returns>
        public GetMenuItemInformation200Response GetMenuItemInformation (int? id)
        {
            ...
            return (GetMenuItemInformation200Response) ApiClient.Deserialize(response.Content, typeof(GetMenuItemInformation200Response), response.Headers);
        }
 ...
 if (showIngredients != null) queryParams.Add("showIngredients", ApiClient.ParameterToString(showIngredients)); // query parameter
        ...
        /// <param name="number">The maximum number of items to return (between 1 and 100). Defaults to 10.</param>
        /// <returns>SearchMenuItems200Response</returns>
        public SearchMenuItems200Response SearchMenuItems (string query, decimal? minCalories, decimal? maxCalories, decimal? minCarbs, decimal? maxCarbs, decimal? minProtein, decimal? maxProtein, decimal? minFat, decimal? maxFat, bool? addMenuItemInformation, int? offset, int? number)
        {
 ...
 if (number != null) queryParams.Add("number", ApiClient.ParameterToString(number)); // query parameter
            ...
            return (SearchMenuItems200Response) ApiClient.Deserialize(response.Content, typeof(SearchMenuItems200Response), response.Headers);
        }
